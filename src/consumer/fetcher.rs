...
pub struct FetchSession {
    ...
    session_topic_names: HashMap<Uuid, TopicName>,
    session_partitions: HashMap<TopicPartition, FetchPartition>,
}
...
impl FetchSession {
    ...
    fn add_topic(&mut self, topic_id: Uuid, topic: TopicName) {
    ...
    fn handle_fetch_response(&mut self, response: &FetchResponse, version: i16) -> bool {
